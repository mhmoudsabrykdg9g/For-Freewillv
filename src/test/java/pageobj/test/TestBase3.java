...
import ftnt.qa.autotest.ui.framework.testbase.DriverFactory;
import ftnt.qa.autotest.ui.framework.testbase.ITestBase;
...
public abstract class TestBase3 implements ITestBase {
	private static final Logger logger = LoggerFactory.getLogger(TestBase3.class);
	protected static WebDriver webDriver;
	protected static String browserType;
	public String website;

	public static void setWebDriver(WebDriver webDriver) {
		TestBase3.webDriver = webDriver;
	}
	...
	public void preCondition() throws Exception {
		website = "https://10.30.2.169/phoenix/licenseUpload.html";
